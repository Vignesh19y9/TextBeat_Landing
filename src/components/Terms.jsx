...
const Terms = () => {
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-4 pb-5">Terms of Service</h1>

      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Terms and Conditions</h2>
        <p className="text-lg">
          Last updated: May 1, 2024 Please read these terms and conditions
      ...
      <section className="pb-10">
        ...
        <p className="text-lg">
          For the purposes of these Terms and Conditions: Application means the
          software program provided by the Company downloaded by You on any
          electronic device, named Reels Templates. Application Store means the
          ...
          directors or other managing authority. Country refers to: Lisbon,
          Portugal Company (referred to as either "the Company", "We", "Us" or
          "Our" in this Agreement) refers to Developer and organisation.
          ...
          free when purchasing a Subscription. In-app Purchase refers to the
          purchase of a product, item, service or Subscription made through the
          Application and subject to these Terms and Conditions and/or the
          Application Store's own terms and conditions. Service refers to the
          Application. Subscriptions refer to the services or access to the
          Service offered on a subscription basis by the Company to You. Terms
          and Conditions (also referred as "Terms") mean these Terms and
          Conditions that form the entire agreement between You and the Company
          regarding the use of the Service. Third-party Social Media
      ...
      <section className="pb-10">
        ...
        <h2 className="text-xl font-bold mb-2">Subscription period</h2>
        <p className="text-lg">
        ...
        <h2 className="text-xl font-bold mb-2">Subscription cancellations</h2>
        <p className="text-lg">
          ...
          Your current Subscription period. If the Subscription has been made
          through an In-app Purchase, You can cancel the renewal of Your
      ...
      <section className="pb-10">
        ...
        <p className="text-lg">
          ...
          billing period as indicated on the invoice. If the Subscription has
          been made through an In-app Purchase, all billing is handled by the
          Application Store and is governed by the Application Store's own terms
          and conditions.
        </p>
      </section>
      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Fee Changes</h2>
        <p className="text-lg">
      ...
      <section className="pb-10">
        ...
        <p className="text-lg">
          ...
          sole discretion of the Company. If the Subscription has been made
          through an In-app purchase, the Application Store's refund policy will
          apply. If You wish to request a refund, You may do so by contacting
      ...
      <section className="pb-10">
        ...
        <p className="text-lg">
          ...
          Free Trial for a limited period of time. You may be required to enter
          Your billing information in order to sign up for the Free Trial. If
          ...
          selected. At any time and without notice, the Company reserves the
      ...
      <section className="pb-10">
        ...
        <p className="text-lg">
          ...
          products, services or Subscriptions. More information about how you
          may be able to manage In-app Purchases using your Device may be set
          out in the Application Store's own terms and conditions or in your
          Device's Help settings. In-app Purchases can only be consumed within
          the Application. If you make a In-app Purchase, that In-app Purchase
          cannot be cancelled after you have initiated its download. In-app
          Purchases cannot be redeemed for cash or other consideration or
          otherwise transferred. If any In-app Purchase is not successfully
          downloaded or does not work once it has been successfully downloaded,
          we will, after becoming aware of the fault or being notified to the
          fault by You, investigate the reason for the fault. We will act
          reasonably in deciding whether to provide You with a replacement
          In-app Purchase or issue You with a patch to repair the fault. In no
          event will We charge You to replace or repair the In-app Purchase. In
          the unlikely event that we are unable to replace or repair the
          relevant In-app Purchase or are unable to do so within a reasonable
          ...
          of the relevant In-app Purchase. Alternatively, if You wish to request
          ...
          conditions. If you have any payment related issues with In-app
          Purchases, then you need to contact the Application Store directly.
        </p>
      </section>
      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Content</h2>
        <h2 className="text-xl font-bold mb-2">Your Right to Post Content</h2>
        <p className="text-lg">
          ...
          these Terms. You represent and warrant that: (i) the Content is Yours
        ...
        <h2 className="text-xl font-bold mb-2">Content Restrictions</h2>
        <p className="text-lg">
          ...
          representatives. Violating the privacy of any third person. False
          information and features. The Company reserves the right, but not the
          obligation, to, in its sole discretion, determine whether or not any
          Content is appropriate and complies with this Terms, refuse or remove
          ...
          posted by users and/or third parties on the Service, you agree to use
          the Service at your own risk. You understand that by using the Service
        ...
        <h2 className="text-xl font-bold mb-2">Content Backups</h2>
        <p className="text-lg">
          ...
          time a backup is performed. The Company will provide support and
      ...
      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Copyright Policy</h2>
        <h2 className="text-xl font-bold mb-2">
      ...
      <section className="pb-10">
        ...
        <p className="text-lg">
          ...
          detail): An electronic or physical signature of the person authorized
          to act on behalf of the owner of the copyright's interest. A
      ...
      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Your Feedback to Us</h2>
        <p className="text-lg">
      ...
      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Disputes Resolution</h2>
        <p className="text-lg">
      ...
      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Severability and Waiver</h2>
        <h2 className="text-xl font-bold mb-2">Severability</h2>
        <p className="text-lg">
      ...
      <section className="pb-10">
        <h2 className="text-xl font-bold mb-2">Translation Interpretation</h2>
        <p className="text-lg">
