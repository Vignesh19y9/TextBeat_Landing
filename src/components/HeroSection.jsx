...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      <h1 className="text-5xl sm:text-6xl lg:text-7xl text-center tracking-tight font-bold">
        <span
      ...
      <div className="py-10">
        ...
        <img
          className="h-3 w-100 mr-2  fill-blue-500"
          src={waveImg}
          alt="wave"
        />
      </div>
      <div>
        <p className=" text-3xl text-center max-w-4xl tracking-wide  font-light">
          Eliminate hours of complex video editing.
        </p>
        {/* <p className=" text-lg text-center text-white max-w-4xl">
      ...
      <div className="flex justify-center my-10">
        {/* <a
          ...
          style={{
            backgroundImage: "linear-gradient(to right, #560DF8, #fff)",
          }}
        >
          Try Text Beat for free
        </a> */}
        <a href="https://robsapp1.ck.page/textbeats">
          <button
            type="button"
            class="text-black bg-[#fff] hover:bg-[#fff]/90 focus:ring-5 focus:outline-none focus:ring-[#560DF8] font-bold rounded-full text-xl px-10 py-5 text-center inline-flex items-center dark:focus:ring-[#560DF8] dark:hover:bg-[#fff]/80 me-2 mb-2"
          >
            <svg
      ...
      {/* <p className="font-light"> Supported on iOS 14+ devices.</p> */}
