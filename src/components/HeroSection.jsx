  ...
  return (
    <div className="flex justify-center my-10">
      <a href="https://robsapp1.ck.page/textbeats">
        <button
          type="button"
          className="text-black bg-[#fff] hover:bg-[#fff]/90 focus:ring-5 focus:outline-none focus:ring-[#560DF8] font-bold rounded-full text-xl px-10 py-5 text-center inline-flex items-center dark:focus:ring-[#560DF8] dark:hover:bg-[#fff]/80 me-2 mb-2"
        >
          <svg
